...
- [done] TASK-0204 Java provider (docs/roadmap/tasks/TASK-0204.md)

## Phase 3: 100% Parameter Expressiveness

- [done] TASK-0301 Parameter schema + renderer (docs/roadmap/tasks/TASK-0301.md)
- [done] TASK-0302 Advanced parameter editor (docs/roadmap/tasks/TASK-0302.md)
- [done] TASK-0303 Command import (optional) (docs/roadmap/tasks/TASK-0303.md)

    ...
    <DropdownMenu open={open} onOpenChange={onOpenChange}>
      <DropdownMenuTrigger asChild>
        <Button
          ...
          variant="ghost"
          size="icon"
          className="size-7 rounded-sm transition-opacity duration-150 ease-geist opacity-0 group-hover:opacity-75 group-focus-within:opacity-75 data-[state=open]:bg-gray-alpha-200 data-[state=open]:opacity-100"

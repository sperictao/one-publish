    ...
    <div className={cn("relative min-h-0 min-w-0 flex-1", className)}>
      ...
      {showJump && (
        <button
          type="button"
          onClick={handleJump}
          className="absolute bottom-3 left-1/2 flex -translate-x-1/2 items-center gap-1.5 rounded-full border border-border bg-card px-3 py-1.5 text-label-12 font-medium text-foreground shadow-sm animate-fade-in transition-colors duration-150 ease-geist hover:bg-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-interactive/40"
        >

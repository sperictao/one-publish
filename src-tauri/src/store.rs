...
pub(crate) use commands::{
    ...
    __cmd__remove_repository, __cmd__replace_recent_publish_config_key, __cmd__save_app_state,
...
pub use commands::{
    ...
    remove_repository, replace_recent_publish_config_key, save_app_state, save_profile,

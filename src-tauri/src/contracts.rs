...
pub fn generate_tauri_contracts() -> String {
    ...
    push_contract::<crate::output_target::MountKindDescriptor>(&mut declarations);
    push_contract::<crate::output_target::OutputTargetDescriptor>(&mut declarations);
    ...
    push_contract::<crate::publish_runtime::PreparePublishRuntimeRequest>(&mut declarations);
    push_contract::<crate::publish_runtime::PublishConfigurationContent>(&mut declarations);
    push_contract::<crate::publish_runtime::PublishBaseRevisionRef>(&mut declarations);
    push_contract::<crate::publish_runtime::PublishDraftOrigin>(&mut declarations);
    push_contract::<crate::publish_runtime::PublishDraft>(&mut declarations);
    push_contract::<crate::publish_runtime::PublishSource>(&mut declarations);
    push_contract::<crate::publish_runtime::PublishRunInputs>(&mut declarations);
    push_contract::<crate::publish_runtime::PublishSourceDiagnostic>(&mut declarations);
    push_contract::<crate::publish_runtime::ResolvedPublishSource>(&mut declarations);
    push_contract::<crate::publish_runtime::PublishBlockDiagnostic>(&mut declarations);
    push_contract::<crate::publish_runtime::PreparedOutputSummary>(&mut declarations);
    push_contract::<crate::publish_runtime::PublishRecoverySnapshot>(&mut declarations);
    push_contract::<crate::provider::ProviderTemplate>(&mut declarations);
    push_contract::<crate::provider::ProviderTemplateSummary>(&mut declarations);
    push_contract::<crate::publish_runtime::PublishAdapterCatalog>(&mut declarations);
    push_contract::<crate::publish_runtime::RuntimePlanStage>(&mut declarations);
    push_contract::<crate::publish_runtime::RuntimePlanNodeSummary>(&mut declarations);
    ...
    push_contract::<crate::command_parser::CommandImportDiagnostic>(&mut declarations);
    push_contract::<crate::command_parser::CommandImportResult>(&mut declarations);
    ...
    push_contract::<crate::store::AppliedProjectionBundle>(&mut declarations);
    push_contract::<crate::automation::AutomationApplyResult>(&mut declarations);
    push_contract::<crate::store::AutomationBinding>(&mut declarations);
    push_contract::<crate::automation::AutomationBindingView>(&mut declarations);
    push_contract::<crate::automation::AutomationBindingsView>(&mut declarations);
    push_contract::<crate::automation::AutomationChangeRequest>(&mut declarations);
    ...
    push_contract::<crate::store::PublishSelectionRef>(&mut declarations);
    push_contract::<crate::store::PublishEditStateUpdate>(&mut declarations);
    push_contract::<crate::store::PublishDraftSubmission>(&mut declarations);
    push_contract::<crate::store::ScopedPublishDraft>(&mut declarations);
    ...
    push_contract::<crate::tauri_release::TauriUpdaterSettings>(&mut declarations);
    push_contract::<crate::tauri_release::VersionMirror>(&mut declarations);
    push_contract::<crate::tauri_release::VersionMirrorKind>(&mut declarations);
